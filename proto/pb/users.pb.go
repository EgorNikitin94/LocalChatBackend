...
func (x *UsersUser) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *UsersUser) GetPhone() string {
	if x != nil {
		return x.Phone
	}
	return ""
...
func (x *UsersUser) GetUserTag() string {
	if x != nil {
		return x.UserTag
	}
	return ""
...
type UpdateUser struct {
	...
	User *UsersUser `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`
}
...
func (x *UpdateUser) GetUser() *UsersUser {
	if x != nil {
		return x.User
	}
	return nil
...
var file_users_proto_rawDesc = []byte{
	,
...
var file_users_proto_goTypes = []interface{}{
	(*UsersUser)(nil),  // 0: Users_user
	(*UpdateUser)(nil), // 1: UpdateUser
}
var file_users_proto_depIdxs = []int32{
	0, // 0: UpdateUser.user:type_name -> Users_user
