...
func (x *SysInit) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *SysInited) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *SysError) ProtoReflect() protoreflect.Message {
	mi := &file_sys_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SysError.ProtoReflect.Descriptor instead.
func (*SysError) Descriptor() ([]byte, []int) {
	return file_sys_proto_rawDescGZIP(), []int{4}
}

func (x *SysError) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysError) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *SysError) GetDescription() string {
	if x != nil {
...
var file_sys_proto_rawDesc = []byte{
	,
...
var file_sys_proto_goTypes = []interface{}{
	(*SysInit)(nil),   // 0: SysInit
	(*SysInited)(nil), // 1: SysInited
	(*Ping)(nil),      // 2: Ping
	(*Pong)(nil),      // 3: Pong
	(*SysError)(nil),  // 4: SysError
}
